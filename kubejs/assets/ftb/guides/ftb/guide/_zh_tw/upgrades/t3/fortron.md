...
<Color id="aqua">力場子注能方塊</Color>是解鎖了許多<Color id="gold">世界引擎</Color>專屬的某些自動化機器配方的一項小型升級，包含：<Color id="gold">《應用能源 2》的自動合成</Color>，和某些像是<Color id="gold">《通用機械》</Color>模組中的<Color id="light_purple">傳送器</Color>之類的傳送方塊。
